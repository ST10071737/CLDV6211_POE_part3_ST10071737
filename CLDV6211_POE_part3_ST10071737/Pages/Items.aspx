...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        ...
        <section>
            ...
            <a href="Inspectors.aspx" class="btn btn-primary">Manage Inspectors</a>
        </section>
        ...
        <section>
            ...
            <a href="Cars.aspx" class="btn btn-primary">Manage Cars</a>
        </section>
        ...
        <section>
            ...
            <a href="Driver.aspx" class="btn btn-primary">Manage Drivers</a>
        </section>
    </div>
</asp:Content>
